...
(function() {{
  ...
  var OVERLAY_CSS_TEXT = [
    ...
    '  html body .gti-watermark-hero {{ right: -22% !important; width: 130vmin !important; height: 130vmin !important; opacity: 0.045 !important; }}',
    '}}',
    ...
    '  text-transform: uppercase !important;',
    '  color: rgba(245,239,224,0.55) !important;',
    '}}',
    ...
    '  z-index: 1 !important;',
    '}}',
    'html body .gti-section-accent.left {{ left: 4% !important; top: 18% !important; transform: rotate(-6deg) !important; }}',
    'html body .gti-section-accent.right {{ right: 4% !important; bottom: 12% !important; transform: rotate(4deg) !important; }}',
    '@media (max-width: 900px) {{',
    '  html body .gti-section-accent {{ width: 120px !important; opacity: 0.05 !important; }}',
    '}}'
  ].join('\\n');

...
(function() {{
  ...
  /* Floating deep-nav — pill buttons editorial */
  .deep-nav {{
  ...
  /* PILL BUTTONS — cada link es un boton real con border, bg, hover */
  .deep-nav a {{
  ...
  /* EN/ES language switcher — destacado rojo Suzuki */
  .deep-nav a.lang {{
    margin-left: 6px;
  ...
  /* Bombilla puntito izquierdo (decorativo) */
  .deep-nav .dot {{

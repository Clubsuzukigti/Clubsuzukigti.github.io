...
(function() {{
  ...
  var OVERLAY_CSS_TEXT = [
    ...
    '}}',
    /* === 4 logos Suzuki "S" antiguo flotantes en el hero === */
    ...
    /* 4 posiciones: superior-izq, medio-izq, superior-der (cerca sol), inferior-der */
    'html body .gti-s-logo.pos-1 {{ top: 8% !important; left: 6% !important; width: 68px !important; height: 68px !important; opacity: 0.32 !important; transform: rotate(-8deg) !important; }}',
    'html body .gti-s-logo.pos-2 {{ top: 38% !important; left: 3% !important; width: 44px !important; height: 44px !important; opacity: 0.22 !important; transform: rotate(6deg) !important; }}',
    'html body .gti-s-logo.pos-3 {{ top: 14% !important; right: 8% !important; width: 56px !important; height: 56px !important; opacity: 0.28 !important; transform: rotate(4deg) !important; }}',
    'html body .gti-s-logo.pos-4 {{ bottom: 14% !important; right: 5% !important; width: 88px !important; height: 88px !important; opacity: 0.38 !important; transform: rotate(-3deg) !important; }}',
    '@media (max-width: 720px) {{',
    '  html body .gti-s-logo.pos-1 {{ width: 44px !important; height: 44px !important; opacity: 0.25 !important; }}',
    '  html body .gti-s-logo.pos-2 {{ display: none !important; }}',
    '  html body .gti-s-logo.pos-3 {{ width: 36px !important; height: 36px !important; opacity: 0.22 !important; }}',
    '  html body .gti-s-logo.pos-4 {{ width: 56px !important; height: 56px !important; bottom: 22% !important; right: 6% !important; opacity: 0.3 !important; }}',
    '}}'
  ].join('\\n');

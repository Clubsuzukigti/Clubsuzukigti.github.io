...
(function() {{
  ...
  var OVERLAY_CSS_TEXT = [
    ...
    '  background: repeating-linear-gradient(0deg, rgba(255,255,255,0.04) 0px, rgba(255,255,255,0.04) 9px, transparent 9px, transparent 24px), linear-gradient(180deg, #0A0908 0%, #1A1612 45%, #0A0908 100%) !important;',
    ...
    '  background-color: #FFB347 !important;',
    '  -webkit-mask-image: url("/assets/img/siluetas/swift-front-lineart.svg") !important;',
    '  mask-image: url("/assets/img/siluetas/swift-front-lineart.svg") !important;',
    '  -webkit-mask-size: contain !important;',
    '  mask-size: contain !important;',
    '  -webkit-mask-repeat: no-repeat !important;',
    '  mask-repeat: no-repeat !important;',
    '  -webkit-mask-position: center !important;',
    '  mask-position: center !important;',
    '  animation: gti-enter-glow 2.4s ease-in-out infinite !important;',
    '}}',
    '@keyframes gti-enter-glow {{ 0%,100% {{ opacity: 0.72; transform: scale(1); }} 50% {{ opacity: 1; transform: scale(1.04); }} }}',
    'html body .gti-enter-splash h2 {{',
    ...
    '}}',
    '@keyframes gti-enter-arrow {{ 0%,100% {{ transform: translateY(0); opacity: 0.85; }} 50% {{ transform: translateY(6px); opacity: 1; }} }}',
    '@media (max-width: 720px) {{',
    '  html body .gti-enter-splash .gti-enter-icon {{ width: 180px !important; height: 180px !important; margin-bottom: 24px !important; }}',
    '  html body .gti-enter-splash h2 {{ letter-spacing: 4px !important; }}',
    '}}',
